...
def generator(net_input_z, net_embed_seq, is_train, reuse):
    ...
    with tf.variable_scope("model", reuse=reuse):
        ...
        network = tl.layers.DenseLayer(net_embed_seq, n_units=t_dim,
                    ...
                    W_init = w_init, name='g_embedseq/dense')
        ...
        net_z = tl.layers.DenseLayer(net_z_concat, gf_dim*8*s16*s16,
                        act = tf.identity,
        ...
        net_h0 = tl.layers.BatchNormLayer(net_z, is_train=is_train, gamma_init=gamma_init, name='g_h0/batchnorm')
